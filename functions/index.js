...
// Q-2
for (var i = 0; i < 5; i++) { // Because VAR is function scope not a block scope, if it is LET, we wll get 0,1,2,3..., beacuse let is block scope.
  setTimeout(function () {
    // 3 times 5
    console.log(i);
  }, i * 1000);
...
const fn = (a, x, y, ...numbers) => {  // rest operator should be last
    console.log(x, y)
};
fn(5,6,7,8);
